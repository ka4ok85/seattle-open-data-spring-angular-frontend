...
export class SeattleOpenDataSpringAngularByZipSpecificPage {
    navigateTo() {
        return browser.get('/by-zip/98104');
    }

    /* Sections */
    getMainSection() {
        return element(by.css('app-root ng-component section#by-zip-specific'));
    }
