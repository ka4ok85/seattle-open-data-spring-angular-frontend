...
import { SeattleOpenDataSpringAngularHourlyByZipPage } from './hourly-by-zip.po';
import { Helpers } from './helpers';

describe('seattle-open-data-spring-angular-frontend App', () => {
    let page: SeattleOpenDataSpringAngularHourlyByZipPage;
    let helpers: Helpers;

    beforeEach(() => {
        page = new SeattleOpenDataSpringAngularHourlyByZipPage();
        helpers = new Helpers();
    });
    ...
    it('should display first graph header text', () => {
        ...
        expect(page.getFirstGraphHeaderText()).toEqual('Calls for zip code "98104" hourly breakdown from ' + range.startDate + ' to ' + range.endDate);
    });
    ...
    it('should display correct Title', () => {
        ...
        browser.getTitle().then(function (webpagetitle) {
            expect(webpagetitle).toEqual('DEV Seattle Open Data 911 Calls | Hourly By Zip - 98104');
        });
    });
